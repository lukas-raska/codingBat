...
public class Main {
    ...
    //    bricks. This is a little harder than it looks and can be done without any loops. See also: Introduction to
    //    MakeBricks
    //
    //    makeBricks(3, 1, 8) → true
    //    makeBricks(3, 1, 9) → false
    //    makeBricks(3, 2, 10) → true
    private static boolean makeBricks(int small,
                                      int big,
                                      int goal) {
        int usableBig = goal / 5;
        int neededSmall = goal - Math.min(usableBig,big) * 5;

        return neededSmall <= small;
    }
}
