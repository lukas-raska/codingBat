...
public class Main {
    ...
    //    bound on the number of cigars. Return true if the party with the given values is successful, or false
    //    otherwise.
    //
    //    cigarParty(30, false) → false
    //    cigarParty(50, false) → true
    //    cigarParty(70, true) → true
    private static boolean cigarParty(int cigars,
                                      boolean isWeekend) {
